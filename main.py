...
Workflow:
 1. Read current week's content from Google Drive
 2. Parse posts vs articles, show menu to pick the LinkedIn pillar
 3. Pull your knowledge base + brand images
...
def run(week: str = None, schedule_at: str = None, dry_run: bool = False,
 ...
 console.rule("[bold blue]Social Engine | readyplangrow.com")
 ...
 if not raw_files:
 console.print("[red]No content files found. Have you populated your Drive content folder this week?[/red]")
 return
